...
#define ADC_ENABLE                  ADC_STATUS_CONTROL_REGISTER |= 1 << 7
#define ADC_DISABLE                 ADC_STATUS_CONTROL_REGISTER &= ~(1 << 7)

#define ADC_START_CONVERSION        ADC_STATUS_CONTROL_REGISTER |= 1 << 6
#define ADC_STOP_CONVERSION         ADC_STATUS_CONTROL_REGISTER &= ~(1 << 6)

#define ADC_AUTO_TRIGGER_ENABLE     ADC_STATUS_CONTROL_REGISTER |= 1 << 5
#define ADC_AUTO_TRIGGER_DISABLE    ADC_STATUS_CONTROL_REGISTER &= ~(1 << 5)

//#define ADC_INTERRUPT_FLAG_ENABLE   ADC_STATUS_CONTROL_REGISTER & 0x10

#define ADC_INTERRUPT_ENABLE        ADC_STATUS_CONTROL_REGISTER |= 1 << 3
#define ADC_INTERRUPT_DISABLE       ADC_STATUS_CONTROL_REGISTER &= ~(1 << 3)

#define ADC_PRESCALAR_2             ADC_STATUS_CONTROL_REGISTER |= 1 << 0
#define ADC_PRESCALAR_4             ADC_STATUS_CONTROL_REGISTER |= 1 << 1
#define ADC_PRESCALAR_8             ADC_STATUS_CONTROL_REGISTER |= (1 << 0 | 1 << 1)
#define ADC_PRESCALAR_16            ADC_STATUS_CONTROL_REGISTER |= 1 << 2
#define ADC_PRESCALAR_32            ADC_STATUS_CONTROL_REGISTER |= (1 << 0 | 1 << 2)
#define ADC_PRESCALAR_64            ADC_STATUS_CONTROL_REGISTER |= (1 << 1 | 1 << 2)
#define ADC_PRESCALAR_128            |= (1 << 0 | 1 << 1 | 1 << 2)

#define ADC_CONVERSION_COMPLETE     ADC_STATUS_CONTROL_REGISTER & 0x70
